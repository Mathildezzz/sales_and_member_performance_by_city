delete from tutorial.mz_member_performance_by_city_maturity;  -- for the subsequent update
insert into tutorial.mz_member_performance_by_city_maturity
